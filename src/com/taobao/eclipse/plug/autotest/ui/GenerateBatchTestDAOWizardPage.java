...
public class GenerateBatchTestDAOWizardPage extends WizardPage {
	...
	public GenerateBatchTestDAOWizardPage(String pageName) {
		super(pageName);
		setTitle(pageName);
		setMessage("java测试用例 自动生成工具，只需要提供java源目录和输出测试用例目录就可以的");
	}
	...
	public void createControl(Composite parent) {
		...
		daoJavaPackage.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				IPath path = null;
				ContainerSelectionDialog dialog = new ContainerSelectionDialog(null, null, false, "请从项目中选择java源路径");
				dialog.setTitle("java源路径选择");
